...
import { useJournalTabController } from "../../hooks/useJournalTabController"

export default function JournalTab({ classId, jurnal }) {
  ...
  const {
    ...
    handleExportPdf,
    handleExportExcel
  } = useJournalTabController(classId, jurnal);
  ...
  return (
    <div className="mb-6">
              ...
              <table className="w-full inter border-l border-r border-gray-200 min-w-[700px]">
                <thead className="bg-[#AA494E] text-white">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-[13px] font-semibold">Judul Jurnal</th>
                    <th className="px-4 py-3 text-left text-[13px] font-semibold">Tanggal</th>
                    <th className="px-4 py-3 text-center text-[13px] font-semibold">Aksi</th>
                  </tr>
                </thead>
      ...
      <div className="flex flex-col sm:flex-row justify-end items-start sm:items-center p-5 bg-white rounded-[10px] gap-3 mt-6">
